...
class FirebaseService {
  ...
  //     if (googleUser == null) {
  //       Utils.showSnackBar('Error', 'Google Sign-In cancelled.', const Icon(Icons.error));
  //       return;
  //     }
  ...
  //       await FirebaseDatabase.instance.ref('Accounts/$node').set({
  //         'name': user.displayName,
  //         'email': user.email,
  //       });

  //       Utils.showSnackBar('Login', 'Successfully Logged In', const Icon(Icons.check_circle, color: Colors.green));

  //       UserPref.setUser(user.displayName!, user.email!, 'NOPASSWORD', node, user.uid);
  //     }
  //   } catch (e) {
  //     Utils.showSnackBar('Error', Utils.extractFirebaseError(e.toString()), const Icon(Icons.error));
  //   }
  // }

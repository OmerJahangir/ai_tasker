import 'package:ai_tasker/res/constants.dart';
import 'package:ai_tasker/view_model/services/splash_services.dart';
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    offset: Offset(0,2),
                    color: darkOrange.withValues(alpha:.5),
                    blurRadius: 10
                ),
                BoxShadow(
                    offset: Offset(0,-2),
                ...
                BoxShadow(
                    offset: Offset(2,0),
                    color: lightOrange.withValues(alpha:.5),
                    blurRadius: 10
                ),
                BoxShadow(
                    offset: Offset(-2,0),
